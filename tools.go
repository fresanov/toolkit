...
const randomStringSource = "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMOPQRSTUVWXYZ0123456789_+"
...
// Slugify is a very simple means of creating a slug form a string
...
// ReadJSON tries to read the body of the request and converts from json into a go data variable
...
func (t *Tools) PushJSONToRemote(uri string, data interface{}, client ...*http.Client) (*http.Response, int, error) {
	...
	request.Header.Set("Content-Type", "application/header")
	// call the remote uri
